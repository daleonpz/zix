...
// Charecteristic UUID for writing device certificate
#define BT_UUID_CERT_DEVICE_CERTIFICATE_UUID_VAL                                                   \
	BT_UUID_128_ENCODE(0x12345678, 0x1234, 0x5678, 0x1234, 0x56789abcdef1)

// Charecteristic UUID for reading central certificate
...
// 					    &end_handle);
	err = gatt_discover_primary_service(default_conn, &cert_service_uuid.uuid, &start_handle, &end_handle);
	if (err) {
